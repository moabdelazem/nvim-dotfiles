...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    -- Copilot is a plugin that provides code completions and suggestions based on the context of your code.
    {
      'github/copilot.vim',
    },

    -- Setting alpha-nvim
    -- Alpha is a dashboard for Neovim, it can be used as a start screen or as a workspace.
    -- It can be customized with different themes and layouts.
    {
      'goolord/alpha-nvim',
  ...
  -- Add Tmux Intergration With Neovim
  {
